 ...
 */
final class Version20240617101502 extends AbstractMigration
{
...
//        $this->addSql('ALTER TABLE participation ADD signatureVisuel VARCHAR(255) DEFAULT NULL, CHANGE updated_at updated_at DATETIME NOT NULL');
...
//        $this->addSql('ALTER TABLE participation DROP signatureVisuel, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
