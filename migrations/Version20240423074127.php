 ...
 */
final class Version20240423074127 extends AbstractMigration
{
...
//        $this->addSql('ALTER TABLE accreditation ADD CONSTRAINT FK_3BF9D0D883FDE077 FOREIGN KEY (pub_id) REFERENCES image (id)');
