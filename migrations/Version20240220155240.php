 ...
 */
final class Version20240220155240 extends AbstractMigration
{
...
//        $this->addSql('ALTER TABLE accreditation ADD qr_code VARCHAR(255) DEFAULT NULL');
...
//        $this->addSql('ALTER TABLE accreditation DROP qr_code');
