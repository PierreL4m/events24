 ...
 */
final class Version20230821115033 extends AbstractMigration
{
...
//        $this->addSql('CREATE TABLE event_sector_pic (event_id INT NOT NULL, sector_pic_id INT NOT NULL, INDEX IDX_2B0681C1198E85FF (sector_pic_id), INDEX IDX_2B0681C171F7E88B (event_id), PRIMARY KEY(event_id, sector_pic_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
