 ...
 */
final class Version20221128130721 extends AbstractMigration
{
...
//        $this->addSql('ALTER TABLE participant_section ADD updated_at DATETIME');
//        $this->addSql('ALTER TABLE participation ADD updated_at DATETIME');
//        $this->addSql('ALTER TABLE partner ADD updated_at DATETIME');
//        $this->addSql('ALTER TABLE recall_subscribe CHANGE event_id event_id INT NOT NULL');
//        $this->addSql('ALTER TABLE section ADD updated_at DATETIME');
//        $this->addSql('UPDATE image SET path = CONCAT(upload_dir, "/", path) WHERE path != "" AND path NOT LIKE CONCAT(upload_dir, "/%")');
...
//        $this->addSql('ALTER TABLE participant_section DROP updated_at');
