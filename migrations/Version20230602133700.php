 ...
 */
final class Version20230602133700 extends AbstractMigration
{
...
//        $this->addSql('CREATE TABLE picto_sector_event (id INT AUTO_INCREMENT NOT NULL, event_id INT DEFAULT NULL, picto_sector_id INT DEFAULT NULL, INDEX IDX_439AA7AE71F7E88B (event_id), INDEX IDX_439AA7AED4DEC6CB (picto_sector_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
//        $this->addSql('ALTER TABLE picto_sector_event ADD CONSTRAINT FK_439AA7AE71F7E88B FOREIGN KEY (event_id) REFERENCES event (id)');
//        $this->addSql('ALTER TABLE picto_sector_event ADD CONSTRAINT FK_439AA7AED4DEC6CB FOREIGN KEY (picto_sector_id) REFERENCES picto_sector (id)');
