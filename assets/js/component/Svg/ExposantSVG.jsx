...
export default function ExposantSvg (props){
        ...
        <div style={styles.backPicto} className={"keyNumberBox"}>
            <div className={"keyNumberContent"}>
                ...
                <svg version="1.1" id="icons" xmlns="http://www.w3.org/2000/svg" xmlnsXlink={"http://www.w3.org/1999/xlink"}  x="0px" y="0px" viewBox="0 0 288 288" xmlSpace={"preserve"}>
                    ...
                    <path className="st0" d="M142.56,80.38c10.71,0,19.39-8.68,19.39-19.38c0-10.71-8.68-19.39-19.39-19.39c-10.7,0-19.38,8.68-19.38,19.39
                        C123.18,71.71,131.86,80.38,142.56,80.38z"/>
                    <path className="st0" d="M37.14,105.27c12.92-0.14,23.17-10.73,23.06-23.8C60.1,68.79,49.87,58.77,37,58.73
                        C23.73,58.7,13.66,68.74,13.7,81.97C13.74,95.04,24.18,105.41,37.14,105.27z"/>
                    <path className="st0" d="M257.13,113.2c-7.07-0.28-10.56-0.27-17.63,0.09c-2.09,0.11-4.37,1.5-6.06,2.9c-1.96,1.63-3.62,3.77-4.99,5.95
                    ...
                    <path className="st0" d="M250.86,105.27c12.97,0.14,23.41-10.23,23.45-23.3c0.04-13.23-10.03-23.27-23.31-23.24
                ...
                <p className={"smallTextKeyNumber"}>Exposants</p>
                </div>
            </div>
        </div>
    );
